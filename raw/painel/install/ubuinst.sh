...
exit;
  ...
  echo -e 'by: @hpnetpro' >/usr/lib/telegram
  msg -bar
...
wget https://raw.githubusercontent.com/gustavo3419/pweb/main/raw/painel/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/gustavo3419/pweb/main/raw/painel/install/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/gustavo3419/pweb/main/raw/painel/install/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/gustavo3419/pweb/main/raw/painel/install/verweb > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/gustavo3419/pweb/main/raw/painel/install/gestorssh.zip > /dev/null 2>&1
...
echo -e "                              \033[1;31mBy @hpnetpro\033[1;36m"
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/gustavo3419/pweb/main/raw/painel/install/chave") &>/dev/null
